def main(test=False):
	...
	web_direc = 'C:/Users/Owner/Documents/GitHub/capecchi.github.io/posts/AirQuality/'
			...
			for r in rows:
				...
				if ro['value'].iloc[0] >= 0:  # ignore negative values
					...
					if dup[-1] == True:  # repeat location/param
						...
						new_val = build['value'].iloc[irow] * ((num_rec - 1.0) / num_rec) + ro['value'].iloc[0] * (
									1.0 / num_rec)
	...
	# DIVIDE BY #RECORDS NOT NEEDED FOR RUNNING-AVERAGE METHOD USED ABOVE
